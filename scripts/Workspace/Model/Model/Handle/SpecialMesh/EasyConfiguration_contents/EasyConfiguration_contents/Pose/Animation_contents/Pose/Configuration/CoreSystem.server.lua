--[[
    CoreSystem (Script)
    Path: Workspace → Model → Model → Handle → SpecialMesh → EasyConfiguration → EasyConfiguration → Pose → Animation → Pose → Configuration
...
local TextureConfiguration = require(script:WaitForChild("Configuration", 4):GetAttribute("Version"))
